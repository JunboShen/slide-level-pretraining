...
def get_finetune_params():
    ...
    # model settings
    parser.add_argument('--model_arch',     type=str, default="slide_enc6l384d")
    ...
    parser.add_argument('--pretrained',     type=str, default="../dino/test_/checkpoint.pth", help='Pretrained GigaPath slide encoder')
