...
def get_finetune_params():
    ...
    # task settings
    parser.add_argument('--task_cfg_path',  type=str, default='finetune_dino/task_configs/mutation_5_gene.yaml', help='Path to the task configuration file')
    parser.add_argument('--exp_name',       type=str, default='', help='Experiment name')
    parser.add_argument('--pat_strat',      action='store_true', default=True, help='Patient stratification')
    ...
    # model settings
    parser.add_argument('--model_arch',     type=str, default="slide_enc12l768d")
    ...
    parser.add_argument('--pretrained',     type=str, default="/data/xuhw/slide_level_pretraining/dino/dino/run_0720/checkpoint0009.pth", help='Pretrained GigaPath slide encoder')
    parser.add_argument('--freeze',         action='store_true', default=False, help='Freeze pretrained model')
    parser.add_argument('--global_pool',    action='store_true', default=False, help='Use global pooling, will use [CLS] token if False') #TODO: False Or True
    ...
    parser.add_argument('--model_select',   type=str, default='last_epoch', help='Criteria for choosing the model checkpoint', choices=['val', 'last_epoch']) #TODO: Originally last_epoch
