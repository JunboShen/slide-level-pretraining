...
from dinov2.models.slide_encoder.slide_encoder import PatchEmbed #TODO: remove patch_embed from custom_auto_wrap_policy
#TODO: remove patch_embed from custom_auto_wrap_policy
def custom_auto_wrap_policy(module, recurse, nonwrapped_numel):
    # Exclude PatchEmbed from FSDP wrapping
...
def get_fsdp_wrapper(model_cfg, modules_to_wrap=set()):
    ...
    fsdp_wrapper = partial(
        ...
        mixed_precision=None, # TODO: mixed_precision_config, don't use mixed precision for now
        device_id=local_rank,
        sync_module_states=True,
        use_orig_params=True,
        auto_wrap_policy=ModuleWrapPolicy(modules_to_wrap), #TODO: originally: ModuleWrapPolicy(modules_to_wrap),
    )
    return fsdp_wrapper
...
class FSDPCheckpointer(Checkpointer):
    def save(self, name: str, **kwargs: Any) -> None:
        ...
        data = {}
        with FSDP.state_dict_type(self.model, StateDictType.FULL_STATE_DICT): #originally StateDictType.LOCAL_STATE_DICT
