...
class SlideDataset(Dataset):
    def __init__(self,
                root_path: str,
                exlude_data_path: str = '/home/xuhw/jbshen/slide-level-pretraining_new/dinov2/LUAD-5-gene_TCGA.csv',
    ...
    def multi_crop(self, images: torch.Tensor, coords: torch.Tensor) -> tuple:
        ...
        # Get the global crop
        for i in range(2):
            global_images, global_coords = self.get_crop(images, coords, self.global_crops_scale, max_tiles=self.max_tiles)
        ...
        for i in range(self.local_crops_number):
            local_images, local_coords = self.get_crop(images, coords, self.local_crops_scale, max_tiles=max_local_tiles)
...
if __name__ == '__main__':
    ...
    data_path  = '/mnt/hanoverdev/scratch/hanwen/exp/GigaPath/TCGA/1-Long-Sequence-Pretraining/bagof256px_encodings_dinov2_vit-giant_1B/dinov2_features/h5_files/' 
